...
namespace Dolphin.Freight.Migrations
{
    ...
    [Migration("20221228024535_AccountingSetting")]
    partial class AccountingSetting
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dolphin.Freight.AccountingSetting.BillingCodes.BillingCode", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Dolphin.Freight.AccountingSetting.CurrencyTables.CurrencyTable", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dolphin.Freight.AccountingSetting.GlCodes.GlCode", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dolphin.Freight.ImportExport.Common.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dolphin.Freight.ImportExport.Common.Container", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dolphin.Freight.ImportExport.Common.Memo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dolphin.Freight.Settings.Substation.Substation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dolphin.Freight.TradePartners.TradePartner", b =>
                {
                    ...
                    b.Property<string>("BillToAgentCode")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("Dolphin.Freight.AccountingSetting.BillingCodes.BillingCode", b =>
                {
                    b.HasOne("Dolphin.Freight.AccountingSetting.GlCodes.GlCode", "Cost")
                        .WithMany()
                        .HasForeignKey("CostId");

                    b.HasOne("Dolphin.Freight.AccountingSetting.GlCodes.GlCode", "Credit")
                        .WithMany()
                        .HasForeignKey("CreditId");

                    b.HasOne("Dolphin.Freight.AccountingSetting.GlCodes.GlCode", "Deit")
                        .WithMany()
                        .HasForeignKey("DeitId");

                    b.HasOne("Dolphin.Freight.AccountingSetting.GlCodes.GlCode", "Revenue")
                        .WithMany()
            ...
            modelBuilder.Entity("Dolphin.Freight.ImportExport.OceanExports.OceanExportMbl", b =>
                {
                    ...
                    b.HasOne("Dolphin.Freight.Settings.Substation.Substation", "Office")
                        .WithMany()
