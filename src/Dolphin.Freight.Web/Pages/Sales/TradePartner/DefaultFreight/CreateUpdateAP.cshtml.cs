...
{
    public class CreateUpdateAPModal : AbpPageModel
    {
        ...
        [BindProperty]
        public CreateUpdateDefaultFreightAPDto APDto { get; set; }
        ...
        public CreateUpdateAPModal(ITradePartnerDefaultFreightAppService tradePartnerDefaultFreightAppService, IBillingCodeAppService billingCodeAppService)
        {
        ...
        public async Task OnGetAsync()
        {
            ...
            if (Id != null)
            {
                DefaultFreightAPDto dto = await _tradePartnerDefaultFreightAppService.GetAPAsync(Id.Value);
        ...
        {
            await _tradePartnerDefaultFreightAppService.SaveAPAsync(APDto);
            return NoContent();
        }
    }
}
