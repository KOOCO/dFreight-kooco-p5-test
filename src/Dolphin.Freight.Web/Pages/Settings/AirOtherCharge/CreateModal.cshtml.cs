...
namespace Dolphin.Freight.Web.Pages.AirOtherCharge
{
    public class CreateModalModel : FreightPageModel
    {
        ...
        public CreateModalModel(IAirOtherChargeAppService airOtherChargeAppService)
        {
        ...
        {
            await _airOtherChargeAppService.CreateAsync(AirOtherCharge);
            return NoContent();
        }
        ...
        public void OnGet()
        {
            AirOtherCharge = new CreateUpdateAirOtherChargeDTO();
