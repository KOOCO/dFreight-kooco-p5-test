...
public class ProfileManagementPageGroupCustom
{
    public string Id {
        get => _id;
    ...
    public ProfileManagementPageGroupCustom([NotNull] string id, [NotNull] string displayName, [NotNull] Type componentType, object parameter = null)
    {
        Id = id;
